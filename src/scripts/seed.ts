...
const seedData = async () => {
  try {
    ...
    const quizResult = await pool.query(
      'INSERT INTO quizzes (quiz_id, quiz_name, product_page_url, creation_date, is_active) VALUES ($1, $2, $3, $4, $5) RETURNING quiz_id',
      [1, 'Test Setup Quiz', 'http://test-funnelish-redirect.com', new Date(), true]
    );
    ...
    for (const question of questions) {
      await pool.query(
        'INSERT INTO questions (question_id, quiz_id, sequence_order, question_text, interaction_type) VALUES ($1, $2, $3, $4, $5)',
        [question.question_id, quizId, question.sequence_order, question.question_text, question.interaction_type]
      );
    ...
    for (const option of answerOptions) {
      await pool.query(
        'INSERT INTO answer_options (option_id, question_id, option_text, associated_value) VALUES ($1, $2, $3, $4)',
        [option.option_id, option.question_id, option.option_text, option.associated_value]
      );
