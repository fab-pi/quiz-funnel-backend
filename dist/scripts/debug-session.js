...
const debugSession = async () => {
    try {
       ...
       RETURNING session_id`, [sessionId, 1, new Date(), 1, false, 'google', 'cpc', 'test_quiz']);
        console.log('✅ Session created successfully:', result.rows[0].session_id);
        // Clean up
        await db_1.default.query('DELETE FROM user_sessions WHERE session_id = $1', [result.rows[0].session_id]);
